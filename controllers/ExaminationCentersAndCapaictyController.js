...
export const GetCentersDataByExaminationAndExamType = async (req, res) =>{
    ...
    const examType = "S100-EXTENDED-100-SEATS"
    
    console.log("i am in GetCentersDataByExaminationAndExamType ")
...
export const GetCentersDataByExaminationAndExamTypeS100 = async (req, res) =>{
